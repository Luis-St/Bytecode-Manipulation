...
public interface IInjectTest {
	...
	//region HEAD
	@Injector(method = "test(int, int[])", target = @Target(type = TargetType.HEAD), restricted = false)
	...
	//region LAMBDA
	@Injector(method = "test(int, int[])", target = @Target(value = "System#getProperty", type = TargetType.INVOKE, mode = TargetMode.AFTER))
	...
	//region NEW
	@Injector(method = "test(int, int[])", target = @Target(value = "ArrayList", type = TargetType.NEW))
	default void injectNewType(@This InjectTest test) {
		System.out.println("New Type");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "int[]", type = TargetType.NEW))
	...
	//region INVOKE
	@Injector(method = "test(int, int[])", target = @Target(value = "InjectorTest#validate", type = TargetType.INVOKE))
	default void injectInvokePrivate() {
		System.out.println("Invoke Private");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "InjectorTest#silentThrow", type = TargetType.INVOKE))
	default void injectInvokeStatic() {
		System.out.println("Invoke Private");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "List#add", type = TargetType.INVOKE, mode = TargetMode.AFTER, ordinal = 2))
	...
	//region ACCESS
	@Injector(method = "test(int, int[])", target = @Target(value = "#i", type = TargetType.ACCESS))
	default void injectAccessFieldByName() {
		System.out.println("Access Field by Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "InjectorTest#i", type = TargetType.ACCESS, mode = TargetMode.AFTER))
	default void injectAccessFieldByType() {
		System.out.println("Access Field by Type#Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "index", type = TargetType.ACCESS))
	default void injectAccessParameterByName() {
		System.out.println("Access Parameter by Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "1", type = TargetType.ACCESS))
	default void injectAccessParameterByIndex() {
		System.out.println("Access Parameter by Index");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "i", type = TargetType.ACCESS, ordinal = 3))
	default void injectAccessVariableByName(@Local int i) {
		System.out.println("Access Variable by Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "6", type = TargetType.ACCESS))
	...
	//region ACCESS_ARRAY
	@Injector(method = "test(int, int[])", target = @Target(type = TargetType.ACCESS_ARRAY))
	...
	//region ASSIGN
	@Injector(method = "test(int, int[])", target = @Target(value = "#i", type = TargetType.ASSIGN))
	default void injectAssignFieldByName() {
		System.out.println("Assign Field by Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "InjectorTest#i", type = TargetType.ASSIGN, mode = TargetMode.AFTER))
	default void injectAssignFieldByType() {
		System.out.println("Assign Field by Type#Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "index", type = TargetType.ASSIGN, mode = TargetMode.AFTER))
	default void injectAssignParameterByName() {
		System.out.println("Assign Parameter by Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "1", type = TargetType.ASSIGN, ordinal = 1))
	default void injectAssignParameterByIndex() {
		System.out.println("Assign Parameter by Index");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "i", type = TargetType.ASSIGN, ordinal = 1))
	default void injectAssignVariableByName() {
		System.out.println("Assign Variable by Name");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "6", type = TargetType.ASSIGN))
	...
	//region ASSIGN_ARRAY
	@Injector(method = "test(int, int[])", target = @Target(type = TargetType.ASSIGN_ARRAY, ordinal = 11))
	...
	//region CONSTANT
	@Injector(method = "test(int, int[])", target = @Target(value = "100", type = TargetType.CONSTANT))
	default void injectConstant100() {
		System.out.println("Constant with Value '100'");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "0", type = TargetType.CONSTANT, ordinal = 3))
	default void injectConstant0() {
		System.out.println("Constant with Value '0'");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "null", type = TargetType.CONSTANT))
	default void injectConstantNull() {
		System.out.println("Constant with Value 'null'");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "true", type = TargetType.CONSTANT))
	...
	//region STRING
	@Injector(method = "test(int, int[])", target = @Target(value = "String ", type = TargetType.STRING))
	default void injectString() {
		System.out.println("String with Value 'String '");
	}
	
	@Injector(method = "test(int, int[])", target = @Target(value = "null", type = TargetType.STRING))
	...
	@Injector(method = "test(int, int[])", target = @Target(value = "+", type = TargetType.NUMERIC_OPERAND))
	...
	@Injector(method = "test(int, int[])", target = @Target(value = "*", type = TargetType.NUMERIC_OPERAND, ordinal = 1))
	...
	@Injector(method = "test(int, int[])", target = @Target(value = "neg", type = TargetType.NUMERIC_OPERAND))
	...
	//region COMPARE
	@Injector(method = "test(int, int[])", target = @Target(value = "==", type = TargetType.COMPARE))
	...
	@Injector(method = "test(int, int[])", target = @Target(value = "instanceof", type = TargetType.COMPARE))
	...
	//region RETURN
	@Injector(method = "test(int, int[])", target = @Target(type = TargetType.RETURN))
