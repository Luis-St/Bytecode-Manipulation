...
public class BaseMethodVisitor extends MethodVisitor implements Instrumentations {
	...
	public BaseMethodVisitor(@NotNull PreloadContext context, @NotNull Type type, @NotNull MethodData method, @NotNull Runnable markModified) {
		super(Opcodes.ASM9);
	...
	public BaseMethodVisitor(@NotNull MethodVisitor visitor, @NotNull PreloadContext context, @NotNull Type type, @NotNull MethodData method, @NotNull Runnable markModified) {
