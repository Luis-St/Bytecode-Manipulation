package net.luis.bcode.asm.base;

import net.luis.bcode.asm.ASMUtils;
import net.luis.bcode.asm.report.CrashReport;
import net.luis.bcode.asm.report.ReportedException;
...
public abstract class BaseClassTransformer implements ClassFileTransformer {
	...
	private static final List<String> IGNORED_CLASSES = List.of(
		...
		"net/luis/bcode/", // Bytecode Manipulation
		"net/luis/annotations/" // Annotations
	);
