package net.luis.bcode.asm;

import net.luis.annotations.*;
import net.luis.annotations.configuration.factory.ActualType;
import net.luis.annotations.math.*;
import net.luis.annotations.string.*;
import net.luis.annotations.util.ImplicitNotNull;
import net.luis.bcode.asm.signature.SignatureUtils;
import net.luis.bcode.util.Utils;
...
public class Types {
	...
	public static final Type SCOPED_STRING_READER = Type.getType(ScopedStringReader.class);
	public static final Type ACTUAL_TYPE = Type.getType(ActualType.class);
	public static final Type SIGNATURE_UTILS = Type.getType(SignatureUtils.class);
	//endregion
	
	//region Generated types
	public static final Type RUNTIME_UTILS = Type.getType("Lnet/luis/bcode/generated/RuntimeUtils;");
	public static final Type MEMORIZED_SUPPLIER = Type.getType("Lnet/luis/bcode/generated/MemorizedSupplier;");
	
	public static final Type DAEMON_THREAD_FACTORY = Type.getType("Lnet/luis/bcode/generated/DaemonThreadFactory;");
	public static final Type COUNTING_RUNNABLE = Type.getType("Lnet/luis/bcode/generated/CountingRunnable;");
	public static final Type CANCELABLE_RUNNABLE = Type.getType("Lnet/luis/bcode/generated/CancelableRunnable;");
	public static final Type CONTEXT_RUNNABLE = Type.getType("Lnet/luis/bcode/generated/ContextRunnable;");
	//endregion
