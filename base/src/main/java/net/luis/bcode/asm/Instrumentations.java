...
public class Instrumentations {
	...
	public static void instrumentFactoryCall(@NotNull MethodVisitor visitor, @NotNull Type factory, @NotNull Type target, @NotNull String classSignature, @NotNull String methodSignature, int parameterIndex, @NotNull String value) {
		...
		if (methodSignature.isEmpty()) {
			visitor.visitLdcInsn(target.getDescriptor());
			visitor.visitMethodInsn(Opcodes.INVOKESTATIC, TYPE.getInternalName(), "getType", "(Ljava/lang/String;)Lorg/objectweb/asm/Type;", false);
			visitor.visitMethodInsn(Opcodes.INVOKESTATIC, ACTUAL_TYPE.getInternalName(), "of", "(Lorg/objectweb/asm/Type;)Lnet/luis/annotations/configuration/factory/ActualType;", false);
		} else {
			visitor.visitLdcInsn(classSignature);
			visitor.visitLdcInsn(methodSignature);
			loadInteger(visitor, parameterIndex);
			visitor.visitMethodInsn(Opcodes.INVOKESTATIC, RUNTIME_UTILS.getInternalName(), "getActualType", "(Ljava/lang/String;Ljava/lang/String;I)" + ACTUAL_TYPE.getDescriptor(), false);
		}
		...
		visitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, factory.getInternalName(), "create", "(Ljava/lang/String;" + ACTUAL_TYPE.getDescriptor() + "Lnet/luis/utils/io/reader/ScopedStringReader;)Ljava/lang/Object;", false);
